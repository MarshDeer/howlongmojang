...
var cnc1 = document.getElementById('cnc1'); // assuming they follow the order listed on the website, this should be bundles
        var cnc1date = "2020-10-03";
	var cnc1fix = "2024-09-25";
...
var render = function() {
        ...
        var since = moment(cnc1date).countdown(cnc1fix).toString();
